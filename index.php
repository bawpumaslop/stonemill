...
<title>The Stone Mill &mdash; Chef Recipe Kits Shipped Chilled</title>
<meta name="description" content="The Stone Mill ships chef recipe kits with weighed ingredients and a method card. Free delivery over $74, ships chilled from Las Vegas, Nevada.">
<link rel="preconnect" href="https://fonts.googleapis.com">
<link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
<link href="https://fonts.googleapis.com/css2?family=Zilla+Slab:ital,wght@0,400;0,600;1,400&family=Inter:wght@300;400;500;600&display=swap" rel="stylesheet">
...
<style>
:root{
  --ink:#1f1c1a; --ink-soft:#666059; --paper:#fffdfb; --tint:#f4efe9;
  --line:#e4dbd0; --accent:#6b3a5c; --gold:#b08423; --ok:#2f6b46;
  --serif:'Zilla Slab',Georgia,serif; --sans:'Inter',system-ui,sans-serif;
}
...
header{position:sticky;top:0;z-index:60;background:rgba(255,253,251,.95);backdrop-filter:blur(10px);border-bottom:1px solid var(--line)}
.bar{display:flex;align-items:center;gap:28px;height:66px}
.brand{font-family:var(--serif);font-size:20px;font-weight:600;letter-spacing:.05em;line-height:1}
...
.hero-art{position:relative;overflow:hidden;background:#ede6de;min-height:460px}
...
footer{background:var(--ink);color:#eae4de;padding:64px 0 30px;font-size:14.5px}
...
<div class="ticker"><div><span>Free delivery over $74</span><span>GRIST15 &mdash; 15% off orders over $75</span><span>Ships Mon&ndash;Thu, chilled</span><span>Packed in Las Vegas</span><span>Free delivery over $74</span><span>GRIST15 &mdash; 15% off orders over $75</span><span>Ships Mon&ndash;Thu, chilled</span><span>Packed in Las Vegas</span></div></div>

<header>
  <div class="shell bar">
    <a href="#top" class="brand">THE STONE MILL<small>CHEF RECIPE KITS</small></a>
...
<div class="hero">
  <div class="hero-copy">
    <p class="eyebrow">MENU CHANGES EVERY WEDNESDAY</p>
    <h1>Line cook precision,<br>home <em>pace</em>.</h1>
    <p>Restaurant recipes rewritten for one pair of hands and a domestic stove. Nothing here assumes a salamander, a brigade, or a walk-in full of prepped mise.</p>
    <div class="hero-cta">
  ...
  <div class="hero-art" id="heroArt">
    <div class="pricetag"><i>KITS FROM</i><b>$28</b></div>
  </div>
</div>

<section id="new">
  <div class="shell">
    <div class="sec-head"><h2>On the menu</h2><p>New list every Wednesday</p></div>
...
<section class="promise">
  <div class="shell"><div class="promise-grid"><div><b>Free delivery over $74</b><p>Chilled overnight in an insulated liner with gel packs.</p></div><div><b>Rewritten for home</b><p>No step assumes equipment you do not have.</p></div><div><b>Chefs paid per kit</b><p>Recipes are licensed and the kitchen earns on every box.</p></div><div><b>Call the kitchen</b><p>Mon&ndash;Sat, 8 AM &ndash; 5 PM PT at (702) 555-0165.</p></div></div></div>
</section>

<section id="reviews">
  <div class="shell">
    <div class="sec-head"><h2>What buyers say</h2><p>4.7 average across 3,120 boxes</p></div>
    <div class="reviews"><div class="rev"><div class="stars">&#9733;&#9733;&#9733;&#9733;&#9733;</div><p>One hundred and eight degrees outside and the chilled pack was still cold on arrival. I do not know how, but it worked.</p><b>Rhea T.</b><i>Verified buyer &mdash; Henderson, NV</i></div><div class="rev"><div class="stars">&#9733;&#9733;&#9733;&#9733;&#9733;</div><p>The risotto card tells you what the pan should sound like. That single detail is why mine finally came out right.</p><b>Malcolm G.</b><i>Verified buyer &mdash; Flagstaff, AZ</i></div><div class="rev"><div class="stars">&#9733;&#9733;&#9733;&#9733;&#9734;</div><p>Excellent kits, but they use a lot of small containers. Recycling is fine, it is just more unpacking than I expected.</p><b>Junie W.</b><i>Verified buyer &mdash; Las Vegas, NV</i></div></div>
  </div>
</section>
  ...
  <div class="shell">
    ...
    <details>
      ...
      <div class="body">
        ...
        <p>Two codes are live right now: <b>GRIST10</b> takes 10% off any order, and <b>GRIST15</b> takes 15% off orders over $75. One code per order.</p>
      </div>
    </details>
    <details>
      ...
      <div class="body">
        ...
        <p>Prices, promotions and availability may change without notice. Screen calibration can shift how colors appear. Placing an order means you accept these terms and the policies above. Any dispute is governed by the laws of the State of Nevada.</p>
        <p>Questions about your data: privacy@thestonemill.example, from the email used on your order.</p>
      </div>
    </details>
    <details>
      <summary>Contact us</summary>
      <div class="body">
        <p><b>Stone Mill Kitchen LLC</b><br>1410 S 3rd St, Suite 12<br>Las Vegas, NV 89104, United States</p>
        <p>Phone: (702) 555-0165 &nbsp;&middot;&nbsp; Mon&ndash;Sat, 8 AM &ndash; 5 PM PT<br>Email: hello@thestonemill.example</p>
      </div>
    </details>
  </div>
</section>
...
<footer>
  <div class="shell">
    <div class="fgrid">
      <div>
        <div class="brand">THE STONE MILL<small>CHEF RECIPE KITS</small></div>
        <address>Stone Mill Kitchen LLC<br>1410 S 3rd St, Suite 12<br>Las Vegas, NV 89104, United States<br>(702) 555-0165</address>
      </div>
      <div>
        <h4>KITS</h4>
        <ul>
    ...
    <div class="legal">
      <span>&copy; 2026 Stone Mill Kitchen LLC. All rights reserved.</span>
...
<aside class="drawer" id="drawer" aria-label="Box">
  ...
  <div class="pane" id="paneForm">
    ...
    <div class="three">
      ...
      <div class="field"><label for="f-zip">ZIP</label><input id="f-zip" inputmode="numeric" placeholder="89104" autocomplete="postal-code"><span class="err">5 digits</span></div>
    </div>
  ...
  <div class="pane" id="paneDone">
    <div class="done-box">
      ...
      <div class="oid" id="orderId">SM-000000</div>
...
var CFG = {"prefix": "SM", "code10": "GRIST10", "code15": "GRIST15", "imgs": ["photo-1565299624946-b28f40a0ae38", "photo-1473093295043-cdd812d0e601", "photo-1498579150354-977475b7ea0b", "photo-1600803907087-f56d462fd26b", "photo-1616299915952-04c803388e5f", "photo-1556761223-4c4282c73f77", "photo-1532117472055-4d0734b51f31", "photo-1506280754576-f6fa8a873550", "photo-1516100882582-96c3a05fe590", "photo-1414235077428-338989a2e8c0", "photo-1563379926898-05f4575a45d8", "photo-1598023696416-0193a0bcd302", "photo-1532939624-3af1308db9a5", "photo-1592417817098-8fd3d9eb14a5", "photo-1571167366136-b57e07761625"], "freeShip": 74, "flatShip": 11.25, "freeMsg": "free delivery", "options": ["Weeknight", "Family", "Table"], "optionLabel": "Serves", "bagLc": "box", "browseBtn": "Browse kits", "checkoutTitle": "Delivery details", "doneVerb": "shipping to", "edits": [{"label": "Pasta Night", "pid": "M01", "filter": "Pasta"}, {"label": "Slow Sunday", "pid": "M04", "filter": "Mains"}, {"label": "Dessert First", "pid": "M06", "filter": "Sweets"}], "products": [{"id": "M01", "name": "Saffron Risotto Kit", "cat": "Pasta", "tags": ["Weeknight"], "price": 33, "msrp": 55, "shape": "ramen", "print": "solid", "main": ["#c9902a", "#f2e2bc", "#f6efdd"], "alt": ["#6b3a5c", "#e8d2e0", "#f2eaef"], "tag": "THIS WEEK", "fresh": true}, {"id": "M02", "name": "Whipped Feta Starter Kit", "cat": "Starters", "tags": ["Weeknight"], "price": 28, "msrp": 46, "shape": "saladbowl", "print": "solid", "main": ["#6b3a5c", "#e8d2e0", "#f2eaef"], "alt": ["#4a7a5c", "#d8e8de", "#eaf1ec"], "tag": "THIS WEEK", "fresh": true}, {"id": "M03", "name": "Grandma Style Pizza Kit", "cat": "Starters", "tags": ["Feeds Four"], "price": 34, "msrp": 56, "shape": "pizza", "print": "solid", "main": ["#c04a2c", "#f2d3c6", "#f6eae4"], "alt": ["#e0b878", "#f5e7cd", "#f6efe3"], "tag": "THIS WEEK", "fresh": true}, {"id": "M04", "name": "Red Chile Short Rib Kit", "cat": "Mains", "tags": ["Feeds Four"], "price": 62, "msrp": 100, "shape": "steakplate", "print": "solid", "main": ["#8a2f2a", "#e8c0bc", "#f4eae8"], "alt": ["#3a3632", "#c9c2ba", "#eeecea"], "tag": "THIS WEEK", "fresh": true}, {"id": "M05", "name": "Black Pepper Udon Kit", "cat": "Pasta", "tags": ["Weeknight"], "price": 30, "msrp": 50, "shape": "ramen", "print": "solid", "main": ["#4a4a5c", "#d8d8e4", "#eceaf0"], "alt": ["#c9902a", "#f2e2bc", "#f6efdd"], "tag": "", "fresh": false}, {"id": "M06", "name": "Burnt Honey Custard Kit", "cat": "Sweets", "tags": [], "price": 29, "msrp": 48, "shape": "dessert", "print": "solid", "main": ["#c98a3c", "#f2dfc2", "#f5eee2"], "alt": ["#4a2f24", "#d6c0b2", "#f0eae6"], "tag": "", "fresh": false}, {"id": "M07", "name": "Griddle Burger Kit", "cat": "Mains", "tags": ["Feeds Four"], "price": 46, "msrp": 76, "shape": "burger", "print": "solid", "main": ["#c98a3c", "#f2dfc2", "#f5eee2"], "alt": ["#8a4a20", "#e8cdb2", "#f4ebdf"], "tag": "LOW STOCK", "fresh": false}, {"id": "M08", "name": "Hot Soppressata Pizza Kit", "cat": "Starters", "tags": ["Feeds Four"], "price": 38, "msrp": 62, "shape": "pizza", "print": "solid", "main": ["#a03c26", "#eecec2", "#f5eae5"], "alt": ["#4a7a5c", "#d8e8de", "#eaf1ec"], "tag": "", "fresh": false}, {"id": "M09", "name": "Charred Escarole Kit", "cat": "Starters", "tags": ["Weeknight"], "price": 28, "msrp": 46, "shape": "saladbowl", "print": "solid", "main": ["#4a7a5c", "#d8e8de", "#eaf1ec"], "alt": ["#c9902a", "#f2e2bc", "#f6efdd"], "tag": "", "fresh": false}, {"id": "M10", "name": "Pistachio Tart Kit", "cat": "Sweets", "tags": [], "price": 32, "msrp": 54, "shape": "dessert", "print": "solid", "main": ["#7a8f3c", "#e6edcf", "#f0f2e6"], "alt": ["#c98a3c", "#f2dfc2", "#f5eee2"], "tag": "", "fresh": false}, {"id": "M11", "name": "Chili Oil Wonton Kit", "cat": "Pasta", "tags": ["Weeknight"], "price": 31, "msrp": 52, "shape": "ramen", "print": "solid", "main": ["#a8492a", "#f0d2c4", "#f6ebe4"], "alt": ["#4a4a5c", "#d8d8e4", "#eceaf0"], "tag": "", "fresh": false}, {"id": "M12", "name": "Sunday Porchetta Kit", "cat": "Mains", "tags": ["Feeds Four"], "price": 64, "msrp": 104, "shape": "steakplate", "print": "solid", "main": ["#8a5a2a", "#ecd4b8", "#f4ece2"], "alt": ["#6b3a5c", "#e8d2e0", "#f2eaef"], "tag": "", "fresh": false}]};
